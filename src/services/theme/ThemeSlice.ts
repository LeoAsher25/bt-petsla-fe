...
const initialState: ITheme = {
  isLightTheme: getLocalStorage('isLightTheme') || true,
  style: getLocalStorage('style') || _theme.lightTheme,
};
...
const themeSlice = createSlice({
  ...
  reducers: {
    toggleTheme: (state) => {
      ...
      setLocalStorage('style', state.style);
      setLocalStorage('isLightTheme', state.isLightTheme);
    },
  },
  extraReducers: {},
});
